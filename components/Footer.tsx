            ...
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="md:col-span-1">
                    ...
                    <p className="text-sm leading-relaxed mb-6">
                        Defying limits since 1996. We build the world's most powerful gaming machines.
                    </p>
                    <div className="flex gap-4">
                        {/* Social Icons */}
                        <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-white/20 transition-colors">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-white/60">
                        <li><a href="#" className="hover:text-white transition-colors">Alienware Laptops</a></li>
                        <li><a href="#" className="hover:text-white transition-colors">Alienware Desktops</a></li>
                        <li><a href="#" className="hover:text-white transition-colors">Gaming Monitors</a></li>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-white/60">
                        ...
                        <li><a href="#" className="hover:text-white transition-colors">Order Support</a></li>
                        <li><a href="#" className="hover:text-white transition-colors">Contact Us</a></li>
                    </ul>
                </div>

                <div>
                    <h4 className="text-white font-bold uppercase tracking-widest mb-6">Stay Connected</h4>
                    ...
                    <div className="flex flex-col gap-3">
                        <input
                            ...
                            className="bg-white/5 border border-white/10 rounded px-4 py-3 text-sm text-white focus:outline-none focus:border-blue-500 transition-colors"
                        />
                        <button className="bg-white text-black font-bold uppercase tracking-widest text-xs py-3 rounded hover:bg-gray-200 transition-colors">
                            Subscribe
                        </button>
                    </div>
                </div>
